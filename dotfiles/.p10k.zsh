# Generated by Powerlevel10k configuration wizard on 2020-05-20 at 22:04 CDT.
...
() {
  ...
  function prompt_rand_emoji() {
    EMOJIS=(🐳 😺 🐙 🦀 🐹 🐶 🐼 🚀 🐧)
    SELECTED_EMOJI=${EMOJIS[($RANDOM % ${#EMOJIS[@]})+1]};
    p10k segment -i $SELECTED_EMOJI
  }
  ...
  function instant_prompt_rand_emoji() {
    prompt_rand_emoji
  }
